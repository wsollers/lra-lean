# p0-20 Implement Task

P0 title: Replace Cantor nonsymmetric equivalence and injection-only isomorphism.
...
Inputs:
- `docs/p0-repair/prompts/p0-20-spec.md`
- `docs/p0-repair/prompts/p0-20-verify.md`
