...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.TGSet.Set), (LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 A ∧ (∀ (x : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 x → ∀ (y : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 x y → LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 y ∧ (∀ (x : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 x → Exists fun P => (LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 P ∧ ∀ (x_1 : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 P x_1 ↔ ∀ (y : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 x_1 y → LRA.Set.instMembershipTGSet.1 x y) ∧ (∀ (I : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 I → ∀ (family : LRA.Set.Constructions.TGSet.Set → LRA.Set.Constructions.TGSet.Set), (∀ (i : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 I i → LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 (family i)) → Exists fun image => (LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 image ∧ ∀ (y : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 image y ↔ Exists fun i => (LRA.Set.instMembershipTGSet.1 I i ∧ y = family i)) ∧ ∀ (I : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 I → ∀ (family : LRA.Set.Constructions.TGSet.Set → LRA.Set.Constructions.TGSet.Set), (∀ (i : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 I i → LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 (family i)) → Exists fun union => (LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TGSet.IsGrothendieckUniverseFor A) ⋯).1 union ∧ ∀ (x : LRA.Set.Constructions.TGSet.Set), LRA.Set.instMembershipTGSet.1 union x ↔ Exists fun i => (LRA.Set.instMembershipTGSet.1 I i ∧ LRA.Set.instMembershipTGSet.1 (family i) x))))))
