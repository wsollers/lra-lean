...
Predicate logic (unfolded):
  ...
  ∀ (element candidate : LRA.Set.Constructions.TG.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.TG.IsPairSet element element) ⋯).1 candidate ↔ candidate = element
...
Predicate logic (unfolded):
  ...
  ∀ (firstLeft secondLeft firstRight secondRight : LRA.Set.Constructions.TG.Set), Classical.indefiniteDescription (LRA.Set.Constructions.TG.IsPairSet (LRA.Set.Constructions.TG.SingletonSet firstLeft) (LRA.Set.Constructions.TG.PairSet firstLeft firstRight)) ⋯ = .1 (Classical.indefiniteDescription (LRA.Set.Constructions.TG.IsPairSet (LRA.Set.Constructions.TG.SingletonSet secondLeft) (LRA.Set.Constructions.TG.PairSet secondLeft secondRight)) ⋯).1 ↔ (firstLeft = secondLeft ∧ firstRight = secondRight)
