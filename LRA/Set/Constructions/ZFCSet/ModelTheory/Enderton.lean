...
Predicate logic:
  ...
  (Fin (MembershipSignature.relationArity .mem) → LRA.Set.Constructions.ZFCSet) → EndertonMembershipModel.interpretRelation .mem arguments = (arguments ⟨0, by decide⟩ ∈ arguments ⟨1, by decide⟩)

Predicate logic (unfolded):

  ∀ (arguments : Fin (LRA.Set.ModelTheory.MembershipSignature.Relations.2 LRA.Set.ModelTheory.MembershipRelationSymbol.mem) → LRA.Set.Constructions.ZFCSet), LRA.Set.ModelTheory.EndertonMembershipModel.6 LRA.Set.ModelTheory.MembershipRelationSymbol.mem arguments = LRA.Set.instMembershipZFCSet.1 (arguments ⟨(instOfNatNat 1).1, ⋯⟩) (arguments ⟨(instOfNatNat 0).1, ⋯⟩)
...
Predicate logic:
  ...
  EndertonMembershipModel.interpretConstant .emptySet = ∅ ∈ LRA.Set.Constructions.ZFCSet

Predicate logic (unfolded):

  LRA.Set.ModelTheory.EndertonMembershipModel.7 LRA.Set.ModelTheory.MembershipConstantSymbol.emptySet = LRA.Set.Constructions.ZFCSet.instEmptyCollection.1
