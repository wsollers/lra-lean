...
Predicate logic (unfolded):
  ...
  ∀ (A B x : LRA.Set.Constructions.ZFCSet.Axioms.Set), LRA.Set.instMembershipZFCSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.ZFCSet.Axioms.IsSeparatedSubset A fun x => ¬ LRA.Set.instMembershipZFCSet.mem B x) ⋯).1 x ↔ (LRA.Set.instMembershipZFCSet.1 A x ∧ LRA.Set.instMembershipZFCSet.1 B x → False)
...
Predicate logic (unfolded):
  ...
  ∀ {A B D : LRA.Set.Constructions.ZFCSet.Axioms.Set}, (∀ (x : LRA.Set.Constructions.ZFCSet.Axioms.Set), LRA.Set.instMembershipZFCSet.1 D x ↔ (LRA.Set.instMembershipZFCSet.1 A x ∧ LRA.Set.instMembershipZFCSet.1 B x → False)) → D = Classical.indefiniteDescription (LRA.Set.Constructions.ZFCSet.Axioms.IsSeparatedSubset A fun x => ¬ LRA.Set.instMembershipZFCSet.mem B x) ⋯.1
