...
Predicate logic (unfolded):
  ...
  ∀ (element candidate : LRA.Set.Constructions.ZFCSet.Axioms.Set), LRA.Set.instMembershipZFCSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.ZFCSet.Axioms.IsPairSet element element) ⋯).1 candidate ↔ candidate = element
...
Predicate logic (unfolded):
  ...
  ∀ (firstLeft secondLeft firstRight secondRight : LRA.Set.Constructions.ZFCSet.Axioms.Set), Classical.indefiniteDescription (LRA.Set.Constructions.ZFCSet.Axioms.IsPairSet (LRA.Set.Constructions.ZFCSet.Axioms.SingletonSet firstLeft) (LRA.Set.Constructions.ZFCSet.Axioms.PairSet firstLeft firstRight)) ⋯ = .1 (Classical.indefiniteDescription (LRA.Set.Constructions.ZFCSet.Axioms.IsPairSet (LRA.Set.Constructions.ZFCSet.Axioms.SingletonSet secondLeft) (LRA.Set.Constructions.ZFCSet.Axioms.PairSet secondLeft secondRight)) ⋯).1 ↔ (firstLeft = secondLeft ∧ firstRight = secondRight)
