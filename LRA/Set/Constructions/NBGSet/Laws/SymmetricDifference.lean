...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B = LRA.Set.Constructions.NBGSet.instUnion.1 (LRA.Set.Constructions.NBGSet.instSDiff.1 A B) (LRA.Set.Constructions.NBGSet.instSDiff.1 B A)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B = LRA.Set.Constructions.NBGSet.instSDiff.1 (LRA.Set.Constructions.NBGSet.instUnion.1 A B) (LRA.Set.Constructions.NBGSet.instInter.1 A B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B = LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 (LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B) C = LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A (LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A LRA.Set.Constructions.NBGSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 LRA.Set.Constructions.NBGSet.instEmptyCollection.1 A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A A = LRA.Set.Constructions.NBGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B = LRA.Set.Constructions.NBGSet.instEmptyCollection.1 ↔ A = B
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSubset.1 (LRA.Set.Constructions.NBGSet.instHasSymmDiff.1 A B) (LRA.Set.Constructions.NBGSet.instUnion.1 A B)
