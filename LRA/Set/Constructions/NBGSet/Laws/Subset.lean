...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Set), LRA.Set.Constructions.NBGSet.instHasSubset.1 A A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.Constructions.NBGSet.Set), (LRA.Set.Constructions.NBGSet.instHasSubset.1 A B ∧ LRA.Set.Constructions.NBGSet.instHasSubset.1 B C) → LRA.Set.Constructions.NBGSet.instHasSubset.1 A C
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.Constructions.NBGSet.Set), A = B ↔ (LRA.Set.Constructions.NBGSet.instHasSubset.1 A B ∧ LRA.Set.Constructions.NBGSet.instHasSubset.1 B A)
