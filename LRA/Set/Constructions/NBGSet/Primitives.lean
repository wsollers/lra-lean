...
Predicate logic (unfolded):
  ...
  LRA.Set.Constructions.NBGSet → LRA.Set.Constructions.NBGSet → Prop (compiled unfold unavailable; showing predicate logic)
...
Predicate logic (unfolded):
  ...
  LRA.Set.Constructions.NBGSet → LRA.Set.Constructions.NBGClass → Prop (compiled unfold unavailable; showing predicate logic)
...
Predicate logic (unfolded):
  ...
  LRA.Set.Constructions.NBGSet → LRA.Set.Constructions.NBGClass
