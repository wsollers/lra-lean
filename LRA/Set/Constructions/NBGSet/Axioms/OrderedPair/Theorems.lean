...
Predicate logic (unfolded):
  ...
  ∀ (element candidate : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsPairSet element element) ⋯).1 candidate ↔ candidate = element
...
Predicate logic (unfolded):
  ...
  ∀ (firstLeft secondLeft firstRight secondRight : LRA.Set.Constructions.NBGSet.Axioms.Set), Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsPairSet (LRA.Set.Constructions.NBGSet.Axioms.SingletonSet firstLeft) (LRA.Set.Constructions.NBGSet.Axioms.PairSet firstLeft firstRight)) ⋯ = .1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsPairSet (LRA.Set.Constructions.NBGSet.Axioms.SingletonSet secondLeft) (LRA.Set.Constructions.NBGSet.Axioms.PairSet secondLeft secondRight)) ⋯).1 ↔ (firstLeft = secondLeft ∧ firstRight = secondRight)
