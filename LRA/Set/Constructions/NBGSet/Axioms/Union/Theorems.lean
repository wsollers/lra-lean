...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Axioms.Set), Exists fun U => ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 U x ↔ Exists fun B => (LRA.Set.instMembershipNBGSet.1 A B ∧ LRA.Set.instMembershipNBGSet.1 B x)
...
Predicate logic (unfolded):
  ...
  ∀ {A U V : LRA.Set.Constructions.NBGSet.Axioms.Set}, (∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 U x ↔ Exists fun B => (LRA.Set.instMembershipNBGSet.1 A B ∧ LRA.Set.instMembershipNBGSet.1 B x) ∧ ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 V x ↔ Exists fun B => (LRA.Set.instMembershipNBGSet.1 A B ∧ LRA.Set.instMembershipNBGSet.1 B x)) → V = U
...
Predicate logic (unfolded):
  ...
  ∀ (A x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsUnionOf A) ⋯).1 x ↔ Exists fun B => (LRA.Set.instMembershipNBGSet.1 A B ∧ LRA.Set.instMembershipNBGSet.1 B x)
...
Predicate logic (unfolded):
  ...
  ∀ (A B x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsUnionOf (LRA.Set.Constructions.NBGSet.Axioms.PairSet A B)) ⋯).1 x ↔ Or (LRA.Set.instMembershipNBGSet.1 A x) (LRA.Set.instMembershipNBGSet.1 B x)
