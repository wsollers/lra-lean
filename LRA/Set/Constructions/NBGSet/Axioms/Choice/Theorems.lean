...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.Constructions.NBGSet.Axioms.Set) (membersNonempty : ∀ (B : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 A B → Exists fun x => LRA.Set.instMembershipNBGSet.1 B x) (membersPairwiseDisjoint : ∀ (B C : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 A B → LRA.Set.instMembershipNBGSet.1 A C → (B = C → False) → ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 B x → LRA.Set.instMembershipNBGSet.1 C x → False) (B : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 A B → Exists fun x => ((LRA.Set.instMembershipNBGSet.1 B x ∧ LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsChoiceSetFor A) ⋯).1 x) ∧ ∀ (other : LRA.Set.Constructions.NBGSet.Axioms.Set), (LRA.Set.instMembershipNBGSet.1 B other ∧ LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsChoiceSetFor A) ⋯).1 other) → other = x)
