...
Predicate logic (unfolded):
  ...
  Exists fun A => ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 A x → False
...
Predicate logic (unfolded):
  ...
  ∀ {A B : LRA.Set.Constructions.NBGSet.Axioms.Set}, (∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 A x → False ∧ ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 B x → False) → B = A
...
Predicate logic (unfolded):
  ...
  (Exists fun witness => ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 witness x → False ∧ ∀ (left right : LRA.Set.Constructions.NBGSet.Axioms.Set), (∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 left x → False) → (∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 right x → False) → left = right)
...
Predicate logic (unfolded):
  ...
  ∀ (x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 LRA.Set.Constructions.NBGSet.Axioms.TheEmptySet x → False
