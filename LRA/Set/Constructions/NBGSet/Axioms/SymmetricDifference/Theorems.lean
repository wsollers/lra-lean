...
Predicate logic (unfolded):
  ...
  ∀ (A B x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsUnionOf (LRA.Set.Constructions.NBGSet.Axioms.PairSet (LRA.Set.Constructions.NBGSet.Axioms.TheRelativeComplement A B) (LRA.Set.Constructions.NBGSet.Axioms.TheRelativeComplement B A))) ⋯).val x ↔ Or ((LRA.Set.instMembershipNBGSet.1 A x ∧ LRA.Set.instMembershipNBGSet.1 B x → False)) ((LRA.Set.instMembershipNBGSet.1 B x ∧ LRA.Set.instMembershipNBGSet.1 A x → False))
...
Predicate logic (unfolded):
  ...
  ∀ (A B x : LRA.Set.Constructions.NBGSet.Axioms.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.Constructions.NBGSet.Axioms.IsUnionOf (LRA.Set.Constructions.NBGSet.Axioms.PairSet (LRA.Set.Constructions.NBGSet.Axioms.TheRelativeComplement A B) (LRA.Set.Constructions.NBGSet.Axioms.TheRelativeComplement B A))) ⋯).1 x ↔ Or ((LRA.Set.instMembershipNBGSet.1 A x ∧ LRA.Set.instMembershipNBGSet.1 B x → False)) ((LRA.Set.instMembershipNBGSet.1 B x ∧ LRA.Set.instMembershipNBGSet.1 A x → False))
