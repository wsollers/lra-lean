...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFC.Set), (Exists fun w => LRA.Set.instMembershipZFCSet.1 A w) → Exists fun x => (LRA.Set.instMembershipZFCSet.1 A x ∧ ∀ (y : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 x y → LRA.Set.instMembershipZFCSet.1 A y → False)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 A A → False
