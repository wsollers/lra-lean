...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 : LRA.Set.ZFC.Set), Exists fun P => ∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 P w ↔ Or (w = x1)(w = x2)
...
Predicate logic (unfolded):
  ...
  ∀ {x1 x2 P G : LRA.Set.ZFC.Set}, (∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 P w ↔ Or (w = x1)(w = x2) ∧ ∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 G w ↔ Or (w = x1)(w = x2)) → G = P
...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 : LRA.Set.ZFC.Set), (Exists fun witness => (fun P => ∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 P w ↔ Or (w = x1)(w = x2)) witness ∧ ∀ (left right : LRA.Set.ZFC.Set), (∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 left w ↔ Or (w = x1)(w = x2)) → (∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 right w ↔ Or (w = x1)(w = x2)) → left = right)
...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 (Classical.indefiniteDescription (LRA.Set.ZFC.IsPairSet x1 x2) ⋯).1 w ↔ Or (w = x1)(w = x2)
...
Predicate logic (unfolded):
  ...
  ∀ {x1 x2 P : LRA.Set.ZFC.Set}, (∀ (w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 P w ↔ Or (w = x1)(w = x2)) → P = Classical.indefiniteDescription (LRA.Set.ZFC.IsPairSet x1 x2) ⋯.1
...
Predicate logic (unfolded):
  ...
  ∀ (x w : LRA.Set.ZFC.Set), LRA.Set.instMembershipZFCSet.1 (Classical.indefiniteDescription (LRA.Set.ZFC.IsPairSet x x) ⋯).1 w ↔ w = x
