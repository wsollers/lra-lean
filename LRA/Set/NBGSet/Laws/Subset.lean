...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSubset.1 A A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.NBGSet.Set), (LRA.Set.NBGSet.instHasSubset.1 A B ∧ LRA.Set.NBGSet.instHasSubset.1 B C) → LRA.Set.NBGSet.instHasSubset.1 A C
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), A = B ↔ (LRA.Set.NBGSet.instHasSubset.1 A B ∧ LRA.Set.NBGSet.instHasSubset.1 B A)
