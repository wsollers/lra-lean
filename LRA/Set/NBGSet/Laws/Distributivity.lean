...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 A (LRA.Set.NBGSet.instUnion.1 B C) = LRA.Set.NBGSet.instUnion.1 (LRA.Set.NBGSet.instInter.1 A B) (LRA.Set.NBGSet.instInter.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instUnion.1 A (LRA.Set.NBGSet.instInter.1 B C) = LRA.Set.NBGSet.instInter.1 (LRA.Set.NBGSet.instUnion.1 A B) (LRA.Set.NBGSet.instUnion.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instUnion.1 A (LRA.Set.NBGSet.instInter.1 A B) = A
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 A (LRA.Set.NBGSet.instUnion.1 A B) = A
