...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 A B = LRA.Set.NBGSet.instInter.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 (LRA.Set.NBGSet.instInter.1 A B) C = LRA.Set.NBGSet.instInter.1 A (LRA.Set.NBGSet.instInter.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 A A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 LRA.Set.NBGSet.instEmptyCollection.1 A = LRA.Set.NBGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instInter.1 A LRA.Set.NBGSet.instEmptyCollection.1 = LRA.Set.NBGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A1 A2 B1 B2 : LRA.Set.NBGSet.Set), (LRA.Set.NBGSet.instHasSubset.1 A1 A2 ∧ LRA.Set.NBGSet.instHasSubset.1 B1 B2) → LRA.Set.NBGSet.instHasSubset.1 (LRA.Set.NBGSet.instInter.1 A1 B1) (LRA.Set.NBGSet.instInter.1 A2 B2)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSubset.1 A B ↔ LRA.Set.NBGSet.instInter.1 A B = A
