...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A B = LRA.Set.NBGSet.instUnion.1 (LRA.Set.NBGSet.instSDiff.1 A B) (LRA.Set.NBGSet.instSDiff.1 B A)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A B = LRA.Set.NBGSet.instSDiff.1 (LRA.Set.NBGSet.instUnion.1 A B) (LRA.Set.NBGSet.instInter.1 A B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A B = LRA.Set.NBGSet.instHasSymmDiff.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 (LRA.Set.NBGSet.instHasSymmDiff.1 A B) C = LRA.Set.NBGSet.instHasSymmDiff.1 A (LRA.Set.NBGSet.instHasSymmDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A LRA.Set.NBGSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 LRA.Set.NBGSet.instEmptyCollection.1 A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A A = LRA.Set.NBGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSymmDiff.1 A B = LRA.Set.NBGSet.instEmptyCollection.1 ↔ A = B
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.NBGSet.Set), LRA.Set.NBGSet.instHasSubset.1 (LRA.Set.NBGSet.instHasSymmDiff.1 A B) (LRA.Set.NBGSet.instUnion.1 A B)
