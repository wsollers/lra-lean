...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A B = LRA.Set.TGSet.instUnion.1 (LRA.Set.TGSet.instSDiff.1 A B) (LRA.Set.TGSet.instSDiff.1 B A)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A B = LRA.Set.TGSet.instSDiff.1 (LRA.Set.TGSet.instUnion.1 A B) (LRA.Set.TGSet.instInter.1 A B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A B = LRA.Set.TGSet.instHasSymmDiff.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 (LRA.Set.TGSet.instHasSymmDiff.1 A B) C = LRA.Set.TGSet.instHasSymmDiff.1 A (LRA.Set.TGSet.instHasSymmDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A LRA.Set.TGSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 LRA.Set.TGSet.instEmptyCollection.1 A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A A = LRA.Set.TGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSymmDiff.1 A B = LRA.Set.TGSet.instEmptyCollection.1 ↔ A = B
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSubset.1 (LRA.Set.TGSet.instHasSymmDiff.1 A B) (LRA.Set.TGSet.instUnion.1 A B)
