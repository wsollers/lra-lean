...
Predicate logic (unfolded):
  ...
  ∀ (A1 A2 B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSubset.1 A1 A2 → LRA.Set.TGSet.instHasSubset.1 (LRA.Set.TGSet.instSDiff.1 A1 B) (LRA.Set.TGSet.instSDiff.1 A2 B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B1 B2 : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSubset.1 B1 B2 → LRA.Set.TGSet.instHasSubset.1 (LRA.Set.TGSet.instSDiff.1 A B2) (LRA.Set.TGSet.instSDiff.1 A B1)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 A LRA.Set.TGSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 LRA.Set.TGSet.instEmptyCollection.1 A = LRA.Set.TGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 A A = LRA.Set.TGSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 A (LRA.Set.TGSet.instUnion.1 B C) = LRA.Set.TGSet.instInter.1 (LRA.Set.TGSet.instSDiff.1 A B) (LRA.Set.TGSet.instSDiff.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 A (LRA.Set.TGSet.instInter.1 B C) = LRA.Set.TGSet.instUnion.1 (LRA.Set.TGSet.instSDiff.1 A B) (LRA.Set.TGSet.instSDiff.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 (LRA.Set.TGSet.instUnion.1 A B) C = LRA.Set.TGSet.instUnion.1 (LRA.Set.TGSet.instSDiff.1 A C) (LRA.Set.TGSet.instSDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.TGSet.Set), LRA.Set.TGSet.instSDiff.1 (LRA.Set.TGSet.instInter.1 A B) C = LRA.Set.TGSet.instInter.1 (LRA.Set.TGSet.instSDiff.1 A C) (LRA.Set.TGSet.instSDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instHasSubset.1 (LRA.Set.TGSet.instSDiff.1 A B) A
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.TGSet.Set), LRA.Set.TGSet.instInter.1 (LRA.Set.TGSet.instSDiff.1 A B) B = LRA.Set.TGSet.instEmptyCollection.1
