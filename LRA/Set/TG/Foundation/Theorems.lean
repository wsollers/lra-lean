...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set), (Exists fun w => LRA.Set.instMembershipTGSet.1 A w) → Exists fun x => (LRA.Set.instMembershipTGSet.1 A x ∧ ∀ (y : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 x y → LRA.Set.instMembershipTGSet.1 A y → False)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 A A → False
