...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set) (relation : LRA.Set.TG.Set → LRA.Set.TG.Set → Prop), (∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 A x → Exists fun y => (relation x y ∧ ∀ (other : LRA.Set.TG.Set), relation x other → other = y)) → Exists fun B => ∀ (y : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 B y ↔ Exists fun x => (LRA.Set.instMembershipTGSet.1 A x ∧ relation x y)
...
Predicate logic (unfolded):
  ...
  ∀ {A : LRA.Set.TG.Set} {relation : LRA.Set.TG.Set → LRA.Set.TG.Set → Prop} {B C : LRA.Set.TG.Set}, (∀ (y : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 B y ↔ Exists fun x => (LRA.Set.instMembershipTGSet.1 A x ∧ relation x y) ∧ ∀ (y : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 C y ↔ Exists fun x => (LRA.Set.instMembershipTGSet.1 A x ∧ relation x y)) → C = B
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set) (relation : LRA.Set.TG.Set → LRA.Set.TG.Set → Prop) (functional : ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 A x → Exists fun y => (relation x y ∧ ∀ (other : LRA.Set.TG.Set), relation x other → other = y)) (y : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.TG.IsReplacementImageOf A relation) ⋯).1 y ↔ Exists fun x => (LRA.Set.instMembershipTGSet.1 A x ∧ relation x y)
