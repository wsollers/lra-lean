...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set), Exists fun U => ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 U x ↔ Exists fun B => (LRA.Set.instMembershipTGSet.1 A B ∧ LRA.Set.instMembershipTGSet.1 B x)
...
Predicate logic (unfolded):
  ...
  ∀ {A U V : LRA.Set.TG.Set}, (∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 U x ↔ Exists fun B => (LRA.Set.instMembershipTGSet.1 A B ∧ LRA.Set.instMembershipTGSet.1 B x) ∧ ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 V x ↔ Exists fun B => (LRA.Set.instMembershipTGSet.1 A B ∧ LRA.Set.instMembershipTGSet.1 B x)) → V = U
...
Predicate logic (unfolded):
  ...
  ∀ (A x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.TG.IsUnionOf A) ⋯).1 x ↔ Exists fun B => (LRA.Set.instMembershipTGSet.1 A B ∧ LRA.Set.instMembershipTGSet.1 B x)
...
Predicate logic (unfolded):
  ...
  ∀ (A B x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.TG.IsUnionOf (LRA.Set.TG.PairSet A B)) ⋯).1 x ↔ Or (LRA.Set.instMembershipTGSet.1 A x) (LRA.Set.instMembershipTGSet.1 B x)
