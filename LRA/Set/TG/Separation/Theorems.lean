...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set) (property : LRA.Set.TG.Set → Prop), Exists fun B => ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 B x ↔ (LRA.Set.instMembershipTGSet.1 A x ∧ property x)
...
Predicate logic (unfolded):
  ...
  ∀ {A : LRA.Set.TG.Set} {property : LRA.Set.TG.Set → Prop} {B C : LRA.Set.TG.Set}, (∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 B x ↔ (LRA.Set.instMembershipTGSet.1 A x ∧ property x) ∧ ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 C x ↔ (LRA.Set.instMembershipTGSet.1 A x ∧ property x)) → C = B
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.TG.Set) (property : LRA.Set.TG.Set → Prop) (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 (Classical.indefiniteDescription (LRA.Set.TG.IsSeparatedSubset A property) ⋯).1 x ↔ (LRA.Set.instMembershipTGSet.1 A x ∧ property x)
