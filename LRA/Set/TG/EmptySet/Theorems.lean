...
Predicate logic (unfolded):
  ...
  ∀ {A B : LRA.Set.TG.Set}, (∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 A x → False ∧ ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 B x → False) → B = A
...
Predicate logic (unfolded):
  ...
  ∀ (x : LRA.Set.TG.Set), LRA.Set.instMembershipTGSet.1 LRA.Set.TG.TheEmptySet x → False
