...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBG.Set) (property : LRA.Set.NBG.Set → Prop), Exists fun B => ∀ (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 B x ↔ (LRA.Set.instMembershipNBGSet.1 A x ∧ property x)
...
Predicate logic (unfolded):
  ...
  ∀ {A : LRA.Set.NBG.Set} {property : LRA.Set.NBG.Set → Prop} {B C : LRA.Set.NBG.Set}, (∀ (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 B x ↔ (LRA.Set.instMembershipNBGSet.1 A x ∧ property x) ∧ ∀ (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 C x ↔ (LRA.Set.instMembershipNBGSet.1 A x ∧ property x)) → C = B
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.NBG.Set) (property : LRA.Set.NBG.Set → Prop) (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.NBG.IsSeparatedSubset A property) ⋯).1 x ↔ (LRA.Set.instMembershipNBGSet.1 A x ∧ property x)
