...
Predicate logic (unfolded):
  ...
  ∀ (property : LRA.Set.NBG.Set → Prop), Exists fun C => ∀ (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSetNBGClass.1 C x ↔ property x
...
Predicate logic (unfolded):
  ...
  ∀ (property : LRA.Set.NBG.Set → Prop) (x : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSetNBGClass.1 (Classical.indefiniteDescription (LRA.Set.NBG.IsClassComprehension property) ⋯).1 x ↔ property x
