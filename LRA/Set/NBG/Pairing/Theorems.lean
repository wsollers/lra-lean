...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 : LRA.Set.NBG.Set), Exists fun P => ∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 P w ↔ Or (w = x1)(w = x2)
...
Predicate logic (unfolded):
  ...
  ∀ {x1 x2 P G : LRA.Set.NBG.Set}, (∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 P w ↔ Or (w = x1)(w = x2) ∧ ∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 G w ↔ Or (w = x1)(w = x2)) → G = P
...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 : LRA.Set.NBG.Set), (Exists fun witness => (fun P => ∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 P w ↔ Or (w = x1)(w = x2)) witness ∧ ∀ (left right : LRA.Set.NBG.Set), (∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 left w ↔ Or (w = x1)(w = x2)) → (∀ (w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 right w ↔ Or (w = x1)(w = x2)) → left = right)
...
Predicate logic (unfolded):
  ...
  ∀ (x1 x2 w : LRA.Set.NBG.Set), LRA.Set.instMembershipNBGSet.1 (Classical.indefiniteDescription (LRA.Set.NBG.IsPairSet x1 x2) ⋯).1 w ↔ Or (w = x1)(w = x2)
