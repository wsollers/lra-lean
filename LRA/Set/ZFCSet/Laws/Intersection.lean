...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 A B = LRA.Set.ZFCSet.instInter.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 (LRA.Set.ZFCSet.instInter.1 A B) C = LRA.Set.ZFCSet.instInter.1 A (LRA.Set.ZFCSet.instInter.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 LRA.Set.ZFCSet.instEmptyCollection.1 A = LRA.Set.ZFCSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 A LRA.Set.ZFCSet.instEmptyCollection.1 = LRA.Set.ZFCSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 A A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A₁ A₂ B₁ B₂ : LRA.Set.ZFCSet.Set), (LRA.Set.ZFCSet.instHasSubset.1 A₁ A₂ ∧ LRA.Set.ZFCSet.instHasSubset.1 B₁ B₂) → LRA.Set.ZFCSet.instHasSubset.1 (LRA.Set.ZFCSet.instInter.1 A₁ B₁) (LRA.Set.ZFCSet.instInter.1 A₂ B₂)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 A B ↔ LRA.Set.ZFCSet.instInter.1 A B = A
