...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 A A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), (LRA.Set.ZFCSet.instHasSubset.1 A B ∧ LRA.Set.ZFCSet.instHasSubset.1 B C) → LRA.Set.ZFCSet.instHasSubset.1 A C
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), A = B ↔ (LRA.Set.ZFCSet.instHasSubset.1 A B ∧ LRA.Set.ZFCSet.instHasSubset.1 B A)
