...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 A (LRA.Set.ZFCSet.instUnion.1 B C) = LRA.Set.ZFCSet.instUnion.1 (LRA.Set.ZFCSet.instInter.1 A B) (LRA.Set.ZFCSet.instInter.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instUnion.1 A (LRA.Set.ZFCSet.instInter.1 B C) = LRA.Set.ZFCSet.instInter.1 (LRA.Set.ZFCSet.instUnion.1 A B) (LRA.Set.ZFCSet.instUnion.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instUnion.1 A (LRA.Set.ZFCSet.instInter.1 A B) = A
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 A (LRA.Set.ZFCSet.instUnion.1 A B) = A
