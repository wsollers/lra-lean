...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A B = LRA.Set.ZFCSet.instUnion.1 (LRA.Set.ZFCSet.instSDiff.1 A B) (LRA.Set.ZFCSet.instSDiff.1 B A)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A B = LRA.Set.ZFCSet.instSDiff.1 (LRA.Set.ZFCSet.instUnion.1 A B) (LRA.Set.ZFCSet.instInter.1 A B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A B = LRA.Set.ZFCSet.instHasSymmDiff.1 B A
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 (LRA.Set.ZFCSet.instHasSymmDiff.1 A B) C = LRA.Set.ZFCSet.instHasSymmDiff.1 A (LRA.Set.ZFCSet.instHasSymmDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A LRA.Set.ZFCSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 LRA.Set.ZFCSet.instEmptyCollection.1 A = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A A = LRA.Set.ZFCSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSymmDiff.1 A B = LRA.Set.ZFCSet.instEmptyCollection.1 ↔ A = B
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 (LRA.Set.ZFCSet.instHasSymmDiff.1 A B) (LRA.Set.ZFCSet.instUnion.1 A B)
