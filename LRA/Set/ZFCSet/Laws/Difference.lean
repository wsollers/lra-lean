...
Predicate logic (unfolded):
  ...
  ∀ (A₁ A₂ B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 A₁ A₂ → LRA.Set.ZFCSet.instHasSubset.1 (LRA.Set.ZFCSet.instSDiff.1 A₁ B) (LRA.Set.ZFCSet.instSDiff.1 A₂ B)
...
Predicate logic (unfolded):
  ...
  ∀ (A B₁ B₂ : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 B₁ B₂ → LRA.Set.ZFCSet.instHasSubset.1 (LRA.Set.ZFCSet.instSDiff.1 A B₂) (LRA.Set.ZFCSet.instSDiff.1 A B₁)
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 A LRA.Set.ZFCSet.instEmptyCollection.1 = A
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 LRA.Set.ZFCSet.instEmptyCollection.1 A = LRA.Set.ZFCSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 A A = LRA.Set.ZFCSet.instEmptyCollection.1
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 A (LRA.Set.ZFCSet.instUnion.1 B C) = LRA.Set.ZFCSet.instInter.1 (LRA.Set.ZFCSet.instSDiff.1 A B) (LRA.Set.ZFCSet.instSDiff.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 A (LRA.Set.ZFCSet.instInter.1 B C) = LRA.Set.ZFCSet.instUnion.1 (LRA.Set.ZFCSet.instSDiff.1 A B) (LRA.Set.ZFCSet.instSDiff.1 A C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 (LRA.Set.ZFCSet.instUnion.1 A B) C = LRA.Set.ZFCSet.instUnion.1 (LRA.Set.ZFCSet.instSDiff.1 A C) (LRA.Set.ZFCSet.instSDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B C : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instSDiff.1 (LRA.Set.ZFCSet.instInter.1 A B) C = LRA.Set.ZFCSet.instInter.1 (LRA.Set.ZFCSet.instSDiff.1 A C) (LRA.Set.ZFCSet.instSDiff.1 B C)
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instHasSubset.1 (LRA.Set.ZFCSet.instSDiff.1 A B) A
...
Predicate logic (unfolded):
  ...
  ∀ (A B : LRA.Set.ZFCSet.Set), LRA.Set.ZFCSet.instInter.1 (LRA.Set.ZFCSet.instSDiff.1 A B) B = LRA.Set.ZFCSet.instEmptyCollection.1
