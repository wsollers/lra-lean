-- LRA/NumberSystems/RealNumbers/IntervalArithmetic.lean
...
Moved from `LRA.VolumeII.RealNumbers.IntervalArithmetic`, content unchanged
except its import of `Extensions` repointed to the new location. Top-level,
