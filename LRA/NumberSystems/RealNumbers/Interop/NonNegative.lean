...
Predicate logic (unfolded):
  ...
  ∀ (real_model : LRA.NumberSystems.RealNumbers.Interface.ModelTheory.RealModel), real_model.signature.toOrderedRingConceptSignature.2 real_model.signature.toZeroOneBundle.2 real_model.signature.toZeroOneBundle.2
...
Predicate logic:
  ...
  ∀ (real_model : LRA.NumberSystems.RealNumbers.Interface.ModelTheory.RealModel) (first second : LRA.NumberSystems.RealNumbers.NonNegative.NonNegativeReal real_model), real_model.leInst.1 first.val second.val

Predicate logic (unfolded):

  ∀ (real_model : LRA.NumberSystems.RealNumbers.Interface.ModelTheory.RealModel) (first second : Subtype fun value => real_model.signature.toOrderedRingConceptSignature.2 real_model.signature.toZeroOneBundle.2 value), real_model.leInst.1 first.1 second.1
