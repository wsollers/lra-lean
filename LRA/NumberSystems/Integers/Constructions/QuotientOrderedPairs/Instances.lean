...
realizes `NumberSystems.Models.DiscretelyOrderedIntegralDomainModel` -- the ring-and-order interface
...
/-- `Carrier whole_data` realizes the generic ring-and-order `DiscretelyOrderedIntegralDomainModel`
...
noncomputable def QuotientOrderedPairsRealizesIntegerModel
    ...
    LRA.NumberSystems.Models.DiscretelyOrderedIntegralDomainModel := by
  sorry
