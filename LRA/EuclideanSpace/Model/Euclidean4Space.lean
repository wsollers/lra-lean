...
/-- Four-dimensional Euclidean coordinate space over a chosen real model. -/
abbrev R4 (real_model : RealModel) := Rn real_model 4

/-- The closed 4-dimensional box. -/
...
/-- The 4-dimensional sphere of radius-squared `radiusSq`. -/
...
/-- The first-order `L_geom` model carried by four-space. -/
