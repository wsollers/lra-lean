...
/-- `thm:chain-rule`, proved via the Carathéodory characterization: the
...
/-- `thm:leibniz-rule`: the general Leibniz rule for the `n`-th
...
/-- `thm:faà-di-bruno`, hand-verified against the general combinatorial
