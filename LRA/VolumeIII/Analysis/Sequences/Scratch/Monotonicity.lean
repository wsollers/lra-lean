...
import LRA.VolumeIII.Analysis.Sequences.Scratch.Tails
...
theorem monotone_convergence_theorem_increasing {x : RealSequence}
...
theorem monotone_convergence_theorem_decreasing {x : RealSequence}
...
theorem unbounded_monotone_divergence_pos {x : RealSequence}
...
theorem unbounded_monotone_divergence_neg {x : RealSequence}
