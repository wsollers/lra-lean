import LRA.Order.Directedness.Directed.Theorems

/-! Volume-I route to the canonical declarations, owned by
`LRA.Order.Directedness.Directed.Theorems`.
...
* `MaximalElementOfDirectedSubsetIsGreatest`
* `ProductOfDirectedSubsetsIsDirected`
-/
