...
This is not a replacement for Mathlib's abstract algebra hierarchy. It is the
project's minimal language for operations, algebraic laws, and lightweight
structures used by sets, logic, and arithmetic constructions.
-/
