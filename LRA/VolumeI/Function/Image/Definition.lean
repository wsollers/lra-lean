...
A set is the direct image of a source set under a typed function when its members
...
The direct image of a source set under a typed function, formed by separating from
...
The range of a typed function, represented as the image of an ambient domain set.
