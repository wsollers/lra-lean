import LRA.VolumeI.Function.Fiber.Relationships
...
/--
The kernel relation of any typed function is an equivalence relation.
-/
...
theorem KernelClassMapsTo.exists_of_range_member
    ...
    (outputInRange :
      output ∈
        (LRA.Function.Image.Range map ambientDomain : CodomainSet)) :
