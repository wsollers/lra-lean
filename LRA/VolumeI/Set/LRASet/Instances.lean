...
(`_root_.X`) and the backing operation (`LRA.Set.LRASet.X`) to
...
instance : HasCollectionUnion (LRASet Alpha) (LRASet (LRASet Alpha)) where
  collectionUnion := LRA.Set.LRASet.CollectionUnion

instance : HasCollectionIntersection (LRASet Alpha) (LRASet (LRASet Alpha)) where
  collectionIntersection := LRA.Set.LRASet.CollectionIntersection
