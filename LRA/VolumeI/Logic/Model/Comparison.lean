...
import LRA.VolumeI.Logic.Model.Comparison.Reduct
import LRA.VolumeI.Logic.Model.Comparison.Expansion
...
(same-signature domain-level comparison); and worked examples (the
`Z ↪ Q ↪ R` chain over `L_OrderedRing`).
-/
