...
**Inventory:** 55 entries across 17 module(s) (21 completed, 34 sorry, 0 axiomatic assumptions), 0 of which are an `instance` law rather than a `theorem`/`lemma`.
...
Source: ./Monoid/Laws/Definition.lean#L31
...
Transliterated theorem: ∀ a : R, a * a⁻¹ = 1
Logical form (Lean): [Mul R] [Inv R] [OfNat R 1] [MultiplicativeGroupInverseLaws R] : ∀ a : R, a * a⁻¹ = 1
Source: ./Group/Laws/Definition.lean#L35
...
Source: ./AdditiveMonoid/Laws/Definition.lean#L31
...
Transliterated theorem: ∀ a : R, a + -a = 0
Logical form (Lean): [Add R] [Neg R] [OfNat R 0] [AdditiveInverseLaws R] : ∀ a : R, a + -a = 0
Source: ./AdditiveGroup/Laws/Definition.lean#L41
...
Source: ./AdditiveGroup/Laws/Definition.lean#L45
...
Source: ./Semiring/Laws/Distributive.lean#L27
...
Source: ./Semiring/Laws/Definition.lean#L38
...
Predicate logic (unfolded): ∀ {R : Type u} [inst : Add R], LRA.AlgebraicStructures.AdditiveCancellativeLaws R → LRA.Operation.Laws.Cancellation.TwoSidedCancellative fun a b => instHAdd.hAdd a b
...
Source: ./CommutativeSemiringWithoutZero/Laws/Definition.lean#L32
...
Predicate logic (unfolded): ∀ {R : Type u} [inst : Mul R], LRA.AlgebraicStructures.MultiplicativeCancellativeLaws R → LRA.Operation.Laws.Cancellation.TwoSidedCancellative fun a b => instHMul.hMul a b
Transliterated theorem: LRA.Operation.Laws.Cancellation.TwoSidedCancellative fun a b ∈ R => a * b
...
Source: ./CommutativeSemiringWithoutZero/Laws/Definition.lean#L35
...
Source: ./DivisionRing/Laws/Definition.lean#L42
...
Source: ./DivisionRing/Laws/Definition.lean#L46
...
Predicate logic (unfolded): ∀ {R : Type u} [inst : Add R] [inst_1 : LT R] [inst_2 : OfNat R 0], LRA.AlgebraicStructures.ArchimedeanLaw R → ∀ (x : R), inst_1.lt 0 x → LRA.Order.Cofinal (fun x1 x2 => inst_1.lt x1 x2) (LRA.AlgebraicStructures.Multiples x)
...
Source: ./Archimedean/Definition.lean#L24
...
Source: ./DiscreteInteger/Laws/Definition.lean#L68
...
Source: ./DiscreteInteger/Laws/Definition.lean#L71
...
Source: ./DiscreteInteger/Laws/Definition.lean#L79
...
Source: ./DiscreteInteger/Laws/Definition.lean#L83
...
Source: ./DiscreteInteger/Laws/Definition.lean#L91
...
Source: ./DiscreteInteger/Laws/Definition.lean#L95
