...
structure AbsoluteValueData (rational_model : RationalModel) where
  absolute_value :
...
def distance
    ...
    (absolute_value_data : AbsoluteValueData rational_model)
...
structure Representative
    (rational_model : RationalModel)
    (absolute_value_data : AbsoluteValueData rational_model) where
