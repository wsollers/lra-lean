...
noncomputable def addition : Carrier natural_data → Carrier natural_data → Carrier natural_data
  ...
  | some left, some right =>
      some (LRA.NumberSystems.NaturalNumbers.Constructions.Landau.LandauAddition natural_data.model left right)
```
-/
noncomputable def addition : Carrier natural_data → Carrier natural_data → Carrier natural_data
  | none, right => right
...
noncomputable def multiplication : Carrier natural_data → Carrier natural_data → Carrier natural_data
  ...
  | _, none => none
  | some left, some right =>
      some (LRA.NumberSystems.NaturalNumbers.Constructions.Landau.LandauMultiplication natural_data.model left right)
```
-/
noncomputable def multiplication : Carrier natural_data → Carrier natural_data → Carrier natural_data
  | none, _ => none
