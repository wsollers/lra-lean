import LRA.ModelTheory.Comparison.ModelEmbedding
...
Predicate logic (unfolded):
  ...
  ∀ {S : LRA.Logic.Signature} {M₁ : LRA.ModelTheory.FirstOrder.Model S} {M₂ : LRA.ModelTheory.FirstOrder.Model S} (iso : LRA.ModelTheory.FirstOrder.ModelIsomorphism M₁ M₂), (∀ ⦃a₁ a₂ : M₁.1⦄, iso.toModelEmbedding.1 a₁ = iso.toModelEmbedding.1 a₂ → a₁ = a₂ ∧ ∀ (b : M₂.1), Exists fun a => iso.toModelEmbedding.1 a = b)
