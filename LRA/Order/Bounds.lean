...
Backend-neutral supremum and infimum theorems are exposed here. Set-algebra
interaction theorems and top/bottom definitions remain outside this aggregate
until their set-interface dependencies have canonical paths.
-/
