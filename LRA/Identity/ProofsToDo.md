...
**Inventory:** 35 entries across 10 module(s) (0 completed, 33 sorry, 2 axiomatic assumptions), 0 of which are an `instance` law rather than a `theorem`/`lemma`.
...
Kind: Axiom
State: Axiom
Predicate logic: ∀ {Carrier : Type u} (element : Carrier), element = element end LRA.Identity
Predicate logic (unfolded): ∀ {Carrier : Type u} (element : Carrier), element = element
Transliterated theorem: (∀ element ∈ Carrier), element = element end LRA.Identity
Logical form (Lean): {Carrier : Type u} (element : Carrier) : element = element end LRA.Identity
Source: ./Axioms/Reflexivity.lean#L9
...
Kind: Axiom
State: Axiom
Predicate logic: ∀ {Carrier : Type u} {left right : Carrier} (ObjectsAreIdentical : left = right), ∀ property : Carrier -> Prop, property left ↔ property right end LRA.Identity
Predicate logic (unfolded): ∀ {Carrier : Type u} {left right : Carrier}, left = right → ∀ (property : Carrier → Prop), property left ↔ property right
Transliterated theorem: (left = right) → ∀ property : Carrier -> Prop, property left ↔ property right end LRA.Identity
Logical form (Lean): {Carrier : Type u} {left right : Carrier} (ObjectsAreIdentical : left = right) : ∀ property : Carrier -> Prop, property left ↔ property right end LRA.Identity
Source: ./Axioms/Leibniz.lean#L9
