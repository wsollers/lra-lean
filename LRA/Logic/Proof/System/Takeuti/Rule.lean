import LRA.Logic.Proof.System.Takeuti.Judgement
...
Predicate logic:
  ...
  ∀ {L : LRA.Logic.Proof.System.Takeuti.Alphabet} (J : LRA.Logic.Proof.System.Takeuti.Judgement L), Exists fun A => J = { antecedent := List.cons A List.nil, succedent := List.cons A List.nil }
