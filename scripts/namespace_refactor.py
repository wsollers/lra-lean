...
REPLACEMENTS = [
    ("open LRA.Analysis.Bounds.Extremal (IsSupremum IsInfimum)",
     "open LRA.Analysis.Bounds (IsSupremum IsInfimum)"),
    ("open LRA.Analysis.Bounds.Extremal\n", "open LRA.Analysis.Bounds.Extremal\nopen LRA.Analysis.Bounds\n"),
    ("LRA.Analysis.Bounds.Extremal.IsUpperBound", "LRA.Analysis.Bounds.IsUpperBound"),
    ("LRA.Analysis.Bounds.Extremal.IsLowerBound", "LRA.Analysis.Bounds.IsLowerBound"),
    ("LRA.Analysis.Bounds.Extremal.IsBoundedAbove", "LRA.Analysis.Bounds.IsBoundedAbove"),
    ("LRA.Analysis.Bounds.Extremal.IsBoundedBelow", "LRA.Analysis.Bounds.IsBoundedBelow"),
    ("LRA.Analysis.Bounds.Extremal.IsBounded", "LRA.Analysis.Bounds.IsBounded"),
    ("LRA.Analysis.Bounds.Extremal.IsMaximum", "LRA.Analysis.Bounds.IsMaximum"),
    ("LRA.Analysis.Bounds.Extremal.IsMinimum", "LRA.Analysis.Bounds.IsMinimum"),
    ("LRA.Analysis.Bounds.Extremal.IsSupremum", "LRA.Analysis.Bounds.IsSupremum"),
    ("LRA.Analysis.Bounds.Extremal.IsInfimum", "LRA.Analysis.Bounds.IsInfimum"),
    ("LRA.VolumeIII.Analysis.Bounding.BoundAlgebra", "LRA.Analysis.Bounds.Algebra"),
    ("LRA.VolumeIII.Analysis.Bounding.ExtremalBounds", "LRA.Analysis.Bounds.Extremal"),
    ("LRA.VolumeIII.Analysis.Bounding.Bounds", "LRA.Analysis.Bounds"),
    ("LRA.VolumeIII.Analysis.Bounding", "LRA.Analysis.Bounds"),
    ...
    ("LRA.VolumeI.Algebra", "LRA.Algebra"),
    ...
    ("LRA.VolumeIII.Analysis", "LRA.Analysis"),
