...
entries = [e for e in data['declarations'] if e['file'] == 'LRA/EuclideanSpace/Model/CartesianPlane.lean']
path = repo / 'LRA/EuclideanSpace/Model/CartesianPlane.lean'
...
for i, (a, b) in enumerate(zip(text, new_text)):
    ...
    if len(text) != len(new_text):
        ...
        print('no_diff_found')
print('tail_text', repr(text[-40:]))
print('tail_new', repr(new_text[-40:]))
